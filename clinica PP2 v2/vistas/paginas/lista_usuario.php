...
<div class="row">
    ...
    <form method="POST" action="controladores/login.controlador.php">
        ...
        <!-- para validar la reconfirmacion de contraseña -->
        <form action="">
            <div class="row">
                <div class="col">
                    <label for="">Ingresar Contraseña</label>
                    <input type="text" id="contra_anterior">
                </div>
                <div class="col">
                    <label for="">Confirmar Contraseña</label>
                    <input type="text" onfocusout="verificar_contraseña()" id="contra_nueva">
        ...
        <script>
            function verificar_contraseña() {
                var contra_anterior = document.getElementById('contra_anterior').value;
                var contra_nueva = document.getElementById('contra_nueva').value;
                if (contra_anterior != contra_nueva) {
